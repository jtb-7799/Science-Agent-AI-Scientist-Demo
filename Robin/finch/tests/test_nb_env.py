...
from fhda.config import NB_ENVIRONMENT_DOCKER_IMAGE
from fhda.utils import (
    NBLanguage,
...
class TestNBEnvironment:
    ...
    async def test_notebook_utils_integration(self):
        ...
        assert "<...output limited...>" in md_content  # For long outputs
    ...
    async def test_process_cell_output_stream(self):
        ...
        assert "<...output limited...>" in limited_output
